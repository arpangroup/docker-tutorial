                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.updateSlider') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <select name="slider_type" class="form-control form-control-lg">
                                <option value="0" @if($slider->slider_type == 'BANNER') selected="selected" @endif>Banner</option>
                                <option value="1" @if($slider->slider_type == 'TOP_PICK') selected="selected" @endif>Top Pick Restaurant</option>
                                <option value="2" @if($slider->slider_type == 'TOP_BRAND') selected="selected" @endif>Top Brands</option>
                                <option value="3" @if($slider->slider_type == 'CUSINE') selected="selected" @endif>Cusine</option>
                                <option value="4" @if($slider->slider_type == 'SPONSOR_RESTAURANT') selected="selected" @endif>Sponsor Restaurants</option>
                                <option value="5" @if($slider->slider_type == 'DISH_CATEGORY') selected="selected" @endif>Dish Category</option>
                                <option value="6" @if($slider->slider_type == 'COUPON') selected="selected" @endif>Coupon</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                ...
                <div class="card-body">
                    ...
                    <div class="row" id="sortable">
                        ...
                        <div class="col-md-3 mb-2 each-slide" data-id="{{ $slide->id }}">
                            ...
                            <img src="{{url("/")}}{{ $slide->image }}" alt="{{ $slide->name }}" width="150" height="150">
