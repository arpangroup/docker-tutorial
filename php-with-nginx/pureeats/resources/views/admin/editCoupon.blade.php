        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.updateCoupon') }}" method="POST">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label">Is Exclusive?</label>
                        <div class="col-lg-9 d-flex align-items-center">
                            <div class="checkbox checkbox-switchery">
                                <input value="true" type="checkbox" class="switchery-primary isactive" @if($coupon->is_exclusive) checked="checked" @endif name="is_exclusive">
                                <p><span class="help-text text-muted">
                                   Coupons marked as exclusive will show on the Home page of Restaurant listing and Offer Section
                                </span>
                                </p>
                            </div>                            
                        </div>
