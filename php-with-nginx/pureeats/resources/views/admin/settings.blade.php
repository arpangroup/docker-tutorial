                    ...
                    <div class="d-lg-flex justify-content-lg-left">
                        ...
                        <div class="tab-content" style="width: 100%; padding: 0 25px;">
                            <div class="tab-pane fade show active" id="generalSettings">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Approx Time in Minute Per Km<span class="badge badge-flat border-grey-800 text-danger text-capitalize mx-1">NEW</span>
                                    ...
                                    <div class="col-lg-9">
                                        <input type="number" class="form-control form-control-lg" name="approxDeliveryTimePerKm"
                                            value="{{ config('settings.approxDeliveryTimePerKm') }}"
                                            placeholder="Approx. time per KM">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Use Delivery Time Using Distance Matrix  API.<i class="icon-question3 ml-1" data-popup="tooltip" title="Google APIs will be used for calculating the delivery distance" data-placement="top"></i>
                                    </strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                            <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('settings.enDistanceMatrixDeliveryTime')=="true" ) checked="checked"
                                            @endif name="enDistanceMatrixDeliveryTime"> 
                                            <b><span class="mt-1"><span class="text-danger"> IMPORTANT: </span>Donot enable Google Distance Matrix API without first follow </span> <a href="https://docs.foodomaa.com/configurations/google-distance-matrix-api" target="_blank"> this documentation.</a><br>You will get a longer loading screen on the Home page if this documentation is not followed.</b>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="seoSettings">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 offset-lg-3">
                                        <img src="{{url("/")}}/assets/img/social/{{ config('settings.seoOgImage') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 offset-lg-3">
                                        <img src="{{url("/")}}/assets/img/social/{{ config('settings.seoTwitterImage') }}"
                            ...
                            <div class="tab-pane fade" id="designSettings">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 offset-lg-3">
                                        <img src="{{url("/")}}/assets/img/logos/{{ config('settings.storeLogo') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 offset-lg-3">
                                        <img src="{{url("/")}}/assets/img/favicons/{{ config('settings.favicon-96x96') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 offset-lg-3">
                                        <img src="{{url("/")}}/assets/img/splash/{{ config('settings.splashLogo') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 offset-lg-3">
                                        <img src="{{url("/")}}/{{ config('settings.firstScreenHeroImage') }}"
                            ...
                            <div class="tab-pane fade" id="paymentGatewaySettings">
                                ...
                                <hr>
                                <h2> <img src="{{url("/")}}/assets/img/various/paypal.png" alt="PayPal" style="width: 35px"> PayPal</h2>
                                <div class="form-group row">
                                ...
                                <hr>
                                <h2> <img src="{{url("/")}}/assets/img/various/razorpay.png" alt="Razorpay" style="width: 35px"> Razorpay</h2>
                                <div class="form-group row">
...
{{--                        <span class="help-text text-muted mt-2"> The lesser the value, the more load on the server. Recommended is <strong>15 Seconds </strong></span>--}}
            ...
            <div class="tab-pane fade" id="restaurantDashboardSettings">
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Order Auto Cancel Time:</strong></label>
                    <div class="col-lg-9">
                        <select name="orderAutoCancelTime" class="form-control form-control-lg select">
                        <option value="1" @if(config('settings.orderAutoCancelTime') == "1") selected @endif>1 Minute</option>
                        <option value="2" @if(config('settings.orderAutoCancelTime') == "2") selected @endif>2 Minute</option>
                        <option value="3" @if(config('settings.orderAutoCancelTime') == "3") selected @endif>3 Minute</option>
                        <option value="4" @if(config('settings.orderAutoCancelTime') == "4") selected @endif>4 Minute</option>
                        <option value="5" @if(config('settings.orderAutoCancelTime') == "5") selected @endif>5 Minute</option>
                        <option value="10" @if(config('settings.orderAutoCancelTime') == "10") selected @endif>10 Minute</option>
                        <option value="15" @if(config('settings.orderAutoCancelTime') == "15") selected @endif>15 Minute</option>
                        </select>
                        <span class="help-text text-muted mt-2"> The lesser the value, the more load on the server. Recommended is <strong>5 Minute </strong></span>
                    </div>
                </div>
       ...
       $(document).on('keypress', '.tipss .select2-search__field', function () {
        ...
        $("#restaurantNotificationTone").change(function(event) {
            ...
            let notification = document.createElement('audio');
               notification.setAttribute('src', '{{url("/")}}/assets/backend/tones/'+selectedFile+'.mp3');
