                        ...
                        <div class="tab-content" style="width: 100%; padding: 0 25px;">
                            ...
                            <div class="tab-pane fade show active" id="generalSettings">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <img src="{{url("/")}}{{ $restaurant->image }}" alt="Image" width="160" style="border-radius: 0.275rem;">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><span class="text-danger">*</span>Contact Number</label>
                                    <div class="col-lg-9">
                                        <input value="{{ $restaurant->contact_number }}" type="number" class="form-control form-control-lg" name="contact_number" placeholder="Enter Contact Number" required="">
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="metaDataSettings">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input value="{{ $restaurant->rating }}" type="number" class="form-control form-control-lg" name="rating"
                                             placeholder="0">
                                    </div>
                                </div>
                                <div class="form-group row">
