        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.createSlider') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label">Slider Type:</label>
                        <div class="col-lg-9">
                            <select name="slider_type" class="form-control form-control-lg">
                                <option value="BANNER">Banner Slider</option>
                                <option value="TOP_PICK">Top Pick Restaurant</option>
                                <option value="TOP_BRAND">Top Brands</option>
                                <option value="CUSINE">Cusine</option>
                                <option value="SPONSOR_RESTAURANT">Sponsor Restaurants</option>
                                <option value="DISH_CATEGORY">Dish Category</option>
